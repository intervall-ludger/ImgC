...
class TestImgc(unittest.TestCase):
    ...
    def test_save(self):
        ...
        save(
            image,
            base_path / f"test_data/{filename}_optimized.jpg",
            max_size=1,
            min_size=0.5,
        )
        ...
        save(
            image,
            base_path / f"test_data/{filename}_unoptimized.jpg",
            max_size=1,
            min_size=0.5,
            min_quality=100,
        )
        ...
        save(
            image,
            base_path / f"test_data/{filename}_constrained.jpg",
            max_size=0.5,
            min_size=0.25,
        )
        self.assertTrue(
            (base_path / f"./test_data/{filename}_constrained.jpg").exists()
        )
